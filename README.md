...
- **Змінена швидкість героя та ворогів, система рівнів** — оптимізовано значення швидкості для комфортного геймплею, розроблена система рівнів
...
~~Якщо Вам як і мені складно грати в подібні ігри, закоментуйте 1020 рядок, щоб кількість життів не зменшувалася :)~~
